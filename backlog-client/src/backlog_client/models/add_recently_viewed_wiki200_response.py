...
class AddRecentlyViewedWiki200Response(BaseModel):
    """
    ...
    attachments: Optional[List[AddRecentlyViewedWiki200ResponseAttachmentsInner]] = None
    shared_files: Optional[List[GetRecentlyViewedIssues200ResponseIssueSharedFilesInner]] = Field(default=None, alias="sharedFiles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attachments": [AddRecentlyViewedWiki200ResponseAttachmentsInner.from_dict(_item) for _item in obj["attachments"]] if obj.get("attachments") is not None else None,
            "sharedFiles": [GetRecentlyViewedIssues200ResponseIssueSharedFilesInner.from_dict(_item) for _item in obj["sharedFiles"]] if obj.get("sharedFiles") is not None else None,
            "stars": obj.get("stars"),
