...
class CreateIssue201Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "projectId", "issueKey", "keyId", "issueType", "summary", "description", "resolution", "priority", "status", "assignee", "category", "versions", "milestone", "startDate", "dueDate", "estimatedHours", "actualHours", "parentIssueId", "customFields", "attachments", "sharedFiles", "stars"]
