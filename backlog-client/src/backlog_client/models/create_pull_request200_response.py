...
class CreatePullRequest200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "projectId", "repositoryId", "number", "summary", "description", "base", "branch", "status", "assignee", "issue", "baseCommit", "branchCommit", "closeAt", "mergeAt", "createdUser", "created", "updatedUser", "updated"]
