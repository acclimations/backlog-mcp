...
class DeleteWatching200ResponseIssue(BaseModel):
    """
    ...
    milestone: Optional[List[StrictStr]] = None
    ...
    shared_files: Optional[List[StrictStr]] = Field(default=None, alias="sharedFiles")
    stars: Optional[List[StrictStr]] = None
