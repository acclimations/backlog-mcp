...
class GetActivity200ResponseContent(BaseModel):
    """
    ...
    comment: Optional[GetActivity200ResponseContentComment] = None
    changes: Optional[List[GetActivity200ResponseContentChangesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comment": GetActivity200ResponseContentComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
            "changes": [GetActivity200ResponseContentChangesInner.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None
        })
        return _obj
