...
class GetActivity200ResponseNotificationsInner(BaseModel):
    """
    ...
    user: Optional[GetIssueCommentNotifications200ResponseInnerUser] = None
    __properties: ClassVar[List[str]] = ["id", "alreadyRead", "reason", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": GetIssueCommentNotifications200ResponseInnerUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
