...
class GetGroups200ResponseInner(BaseModel):
    """
    GetGroups200ResponseInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    members: Optional[List[GetGroups200ResponseInnerMembersInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "members", "displayOrder", "createdUser", "created", "updatedUser", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "members": [GetGroups200ResponseInnerMembersInner.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
