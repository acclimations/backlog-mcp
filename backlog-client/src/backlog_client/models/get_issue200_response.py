...
class GetIssue200Response(BaseModel):
    ...
    issue_type: Optional[GetIssue200ResponseIssueType] = Field(default=None, alias="issueType")
    summary: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    resolution: Optional[StrictStr] = None
    priority: Optional[GetIssue200ResponsePriority] = None
    status: Optional[GetIssue200ResponseIssueType] = None
    assignee: Optional[GetGroups200ResponseInnerMembersInner] = None
    category: Optional[List[Dict[str, Any]]] = None
    versions: Optional[List[Dict[str, Any]]] = None
    milestone: Optional[List[GetIssue200ResponseMilestoneInner]] = None
    ...
    attachments: Optional[List[GetIssue200ResponseAttachmentsInner]] = None
    shared_files: Optional[List[Dict[str, Any]]] = Field(default=None, alias="sharedFiles")
    stars: Optional[List[GetIssue200ResponseStarsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "keyId": obj.get("keyId"),
            "issueType": GetIssue200ResponseIssueType.from_dict(obj["issueType"]) if obj.get("issueType") is not None else None,
            "summary": obj.get("summary"),
            "description": obj.get("description"),
            "resolution": obj.get("resolution"),
            "priority": GetIssue200ResponsePriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "status": GetIssue200ResponseIssueType.from_dict(obj["status"]) if obj.get("status") is not None else None,
            ...
            "milestone": [GetIssue200ResponseMilestoneInner.from_dict(_item) for _item in obj["milestone"]] if obj.get("milestone") is not None else None,
            ...
            "attachments": [GetIssue200ResponseAttachmentsInner.from_dict(_item) for _item in obj["attachments"]] if obj.get("attachments") is not None else None,
            "sharedFiles": obj.get("sharedFiles"),
            "stars": [GetIssue200ResponseStarsInner.from_dict(_item) for _item in obj["stars"]] if obj.get("stars") is not None else None
        })
        return _obj
