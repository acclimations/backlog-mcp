...
class GetIssue200ResponseStarsInner(BaseModel):
    """
    ...
    presenter: Optional[GetGroups200ResponseInnerCreatedUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "title": obj.get("title"),
            "presenter": GetGroups200ResponseInnerCreatedUser.from_dict(obj["presenter"]) if obj.get("presenter") is not None else None,
