...
class GetIssueCommentNotifications200ResponseInnerUserNulabAccount(BaseModel):
    """
    GetIssueCommentNotifications200ResponseInnerUserNulabAccount
    """ # noqa: E501
    nulab_id: Optional[StrictStr] = Field(default=None, alias="nulabId")
    name: Optional[StrictStr] = None
    unique_id: Optional[StrictStr] = Field(default=None, alias="uniqueId")
    __properties: ClassVar[List[str]] = ["nulabId", "name", "uniqueId"]
