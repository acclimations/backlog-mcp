...
class GetIssueTypes200ResponseInner(BaseModel):
    """
    ...
    template_summary: Optional[StrictStr] = Field(default=None, alias="templateSummary")
    template_description: Optional[StrictStr] = Field(default=None, alias="templateDescription")
    __properties: ClassVar[List[str]] = ["id", "projectId", "name", "color", "displayOrder", "templateSummary", "templateDescription"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "templateSummary": obj.get("templateSummary"),
