...
class GetIssues200ResponseInner(BaseModel):
    """
    ...
    shared_files: Optional[List[GetIssues200ResponseInnerSharedFilesInner]] = Field(default=None, alias="sharedFiles")
    stars: Optional[List[GetIssues200ResponseInnerStarsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sharedFiles": [GetIssues200ResponseInnerSharedFilesInner.from_dict(_item) for _item in obj["sharedFiles"]] if obj.get("sharedFiles") is not None else None,
            "stars": [GetIssues200ResponseInnerStarsInner.from_dict(_item) for _item in obj["stars"]] if obj.get("stars") is not None else None
        })
        return _obj
