...
class GetMyRecentlyViewedWikis200Response(BaseModel):
    """
    GetMyRecentlyViewedWikis200Response
    """ # noqa: E501
    page: Optional[GetMyRecentlyViewedWikis200ResponsePage] = None
    updated: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["page", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": GetMyRecentlyViewedWikis200ResponsePage.from_dict(obj["page"]) if obj.get("page") is not None else None,
