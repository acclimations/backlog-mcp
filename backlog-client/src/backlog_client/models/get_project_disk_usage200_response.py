...
class GetProjectDiskUsage200Response(BaseModel):
    """
    GetProjectDiskUsage200Response
    """ # noqa: E501
    project_id: Optional[StrictInt] = Field(default=None, alias="projectId")
    issue: Optional[StrictInt] = None
    wiki: Optional[StrictInt] = None
    file: Optional[StrictInt] = None
    subversion: Optional[StrictInt] = None
    git: Optional[StrictInt] = None
    git_lfs: Optional[StrictInt] = Field(default=None, alias="gitLFS")
