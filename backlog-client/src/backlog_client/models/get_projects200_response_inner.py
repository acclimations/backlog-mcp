...
class GetProjects200ResponseInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "projectKey", "name", "chartEnabled", "useResolvedForChart", "subtaskingEnabled", "projectLeaderCanEditProjectLeader", "useWiki", "useFileSharing", "useWikiTreeView", "useSubversion", "useGit", "useOriginalImageSizeAtWiki", "textFormattingRule", "archived", "displayOrder", "useDevAttributes"]
