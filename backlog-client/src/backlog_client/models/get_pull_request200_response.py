...
class GetPullRequest200Response(BaseModel):
    """
    ...
    issue: Optional[GetPullRequest200ResponseIssue] = None
    ...
    created_user: Optional[GetPullRequest200ResponseCreatedUser] = Field(default=None, alias="createdUser")
    created: Optional[datetime] = None
    updated_user: Optional[GetPullRequest200ResponseCreatedUser] = Field(default=None, alias="updatedUser")
    updated: Optional[datetime] = None
    attachments: Optional[List[Dict[str, Any]]] = None
    stars: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["id", "projectId", "repositoryId", "number", "summary", "description", "base", "branch", "status", "assignee", "issue", "baseCommit", "branchCommit", "mergeCommit", "closeAt", "mergeAt", "createdUser", "created", "updatedUser", "updated", "attachments", "stars"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issue": GetPullRequest200ResponseIssue.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
            ...
            "createdUser": GetPullRequest200ResponseCreatedUser.from_dict(obj["createdUser"]) if obj.get("createdUser") is not None else None,
            "created": obj.get("created"),
            "updatedUser": GetPullRequest200ResponseCreatedUser.from_dict(obj["updatedUser"]) if obj.get("updatedUser") is not None else None,
