...
class GetRateLimit200Response(BaseModel):
    """
    GetRateLimit200Response
    """ # noqa: E501
    rate_limit: Optional[GetRateLimit200ResponseRateLimit] = Field(default=None, alias="rateLimit")
    __properties: ClassVar[List[str]] = ["rateLimit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rateLimit": GetRateLimit200ResponseRateLimit.from_dict(obj["rateLimit"]) if obj.get("rateLimit") is not None else None
        })
        return _obj
