...
class GetRecentlyViewedIssues200Response(BaseModel):
    """
    GetRecentlyViewedIssues200Response
    """ # noqa: E501
    issue: Optional[GetRecentlyViewedIssues200ResponseIssue] = None
    updated: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["issue", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "issue": GetRecentlyViewedIssues200ResponseIssue.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
