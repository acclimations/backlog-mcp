...
class GetRecentlyViewedIssues200ResponseIssue(BaseModel):
    """
    ...
    milestone: Optional[List[GetRecentlyViewedIssues200ResponseIssueMilestoneInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "milestone": [GetRecentlyViewedIssues200ResponseIssueMilestoneInner.from_dict(_item) for _item in obj["milestone"]] if obj.get("milestone") is not None else None,
