...
class GetRecentlyViewedIssues200ResponseIssueStarsInner(BaseModel):
    """
    ...
    presenter: Optional[GetIssueCommentNotifications200ResponseInnerUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "title": obj.get("title"),
            "presenter": GetIssueCommentNotifications200ResponseInnerUser.from_dict(obj["presenter"]) if obj.get("presenter") is not None else None,
