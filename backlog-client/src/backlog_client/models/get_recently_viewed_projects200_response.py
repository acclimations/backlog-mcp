...
class GetRecentlyViewedProjects200Response(BaseModel):
    """
    GetRecentlyViewedProjects200Response
    """ # noqa: E501
    project: Optional[GetProjects200ResponseInner] = None
    updated: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["project", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project": GetProjects200ResponseInner.from_dict(obj["project"]) if obj.get("project") is not None else None,
