...
class GetUserActivities200ResponseInnerContentChangesInner(BaseModel):
    """
    GetUserActivities200ResponseInnerContentChangesInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["field", "new_value", "old_value", "type"]
