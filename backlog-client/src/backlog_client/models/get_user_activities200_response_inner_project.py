...
class GetUserActivities200ResponseInnerProject(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "projectKey", "name", "chartEnabled", "useResolvedForChart", "subtaskingEnabled", "projectLeaderCanEditProjectLeader", "useWiki", "useFileSharing", "useWikiTreeView", "useOriginalImageSizeAtWiki", "textFormattingRule", "archived", "displayOrder", "useDevAttributes"]
