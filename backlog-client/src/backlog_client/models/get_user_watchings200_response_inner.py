...
class GetUserWatchings200ResponseInner(BaseModel):
    """
    ...
    issue: Optional[AddWatching201ResponseIssue] = None
    last_content_updated: Optional[datetime] = Field(default=None, alias="lastContentUpdated")
    created: Optional[datetime] = None
    updated: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "resourceAlreadyRead", "note", "type", "issue", "lastContentUpdated", "created", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "note": obj.get("note"),
            "type": obj.get("type"),
            "issue": AddWatching201ResponseIssue.from_dict(obj["issue"]) if obj.get("issue") is not None else None,
