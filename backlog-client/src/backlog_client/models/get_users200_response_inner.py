...
class GetUsers200ResponseInner(BaseModel):
    """
    ...
    role_type: Optional[StrictInt] = Field(default=None, description="ユーザーの権限。利用するスペースの契約プランにより値の意味が異なります。クラシックプランの場合:1 管理者2 一般ユーザー3 レポーター4 ビューワー5 ゲストレポーター6 ゲストビューワー新プランの場合:1 管理者2 一般ユーザー、ゲスト（制限：制限なし）3 一般ユーザー、ゲスト（制限：課題の登録のみ）4 一般ユーザー、ゲスト（制限：課題の閲覧のみ）", alias="roleType")
    lang: Optional[StrictStr] = Field(default=None, description="ユーザーの言語設定。\\\"en\\\" 英語\\\"ja\\\" 日本語null 未指定")
    nulab_account: Optional[GetIssueCommentNotifications200ResponseInnerUserNulabAccount] = Field(default=None, alias="nulabAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lang": obj.get("lang"),
            "nulabAccount": GetIssueCommentNotifications200ResponseInnerUserNulabAccount.from_dict(obj["nulabAccount"]) if obj.get("nulabAccount") is not None else None,
