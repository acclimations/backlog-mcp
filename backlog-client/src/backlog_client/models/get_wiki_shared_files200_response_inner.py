...
class GetWikiSharedFiles200ResponseInner(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if updated_user (nullable) is None
        # and model_fields_set contains the field
        if self.updated_user is None and "updated_user" in self.model_fields_set:
            _dict['updatedUser'] = None
