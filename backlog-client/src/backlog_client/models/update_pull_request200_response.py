...
class UpdatePullRequest200Response(BaseModel):
    """
    ...
    created_user: Optional[Dict[str, Any]] = Field(default=None, alias="createdUser")
    created: Optional[datetime] = None
    updated_user: Optional[Dict[str, Any]] = Field(default=None, alias="updatedUser")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updatedUser": obj.get("updatedUser"),
