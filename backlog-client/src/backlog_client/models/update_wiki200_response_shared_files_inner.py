...
class UpdateWiki200ResponseSharedFilesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "projectId", "type", "dir", "name", "size", "createdUser", "created", "updatedUser", "updated"]
