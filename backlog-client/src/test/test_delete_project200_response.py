...
class TestDeleteProject200Response(unittest.TestCase):
    """DeleteProject200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteProject200Response:
        """Test DeleteProject200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteProject200Response`
        """
        model = DeleteProject200Response()
        if include_optional:
    ...
    def testDeleteProject200Response(self):
        """Test DeleteProject200Response"""
