...
class TestDeleteWatching200ResponseIssue(unittest.TestCase):
    """DeleteWatching200ResponseIssue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteWatching200ResponseIssue:
        """Test DeleteWatching200ResponseIssue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteWatching200ResponseIssue`
        """
        model = DeleteWatching200ResponseIssue()
        if include_optional:
            return DeleteWatching200ResponseIssue(
                id = 56,
                project_id = 56,
                issue_key = '',
                key_id = 56,
    ...
    def testDeleteWatching200ResponseIssue(self):
        """Test DeleteWatching200ResponseIssue"""
