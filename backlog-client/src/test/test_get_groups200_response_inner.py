...
class TestGetGroups200ResponseInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGroups200ResponseInner:
        ...
        """
        model = GetGroups200ResponseInner()
        if include_optional:
            return GetGroups200ResponseInner(
                id = 56,
                name = '',
                members = [
                    backlog_client.models.get_groups_200_response_inner_members_inner.getGroups_200_response_inner_members_inner(
                        id = 56, 
                        user_id = '', 
                        name = '', 
                        role_type = 56, 
