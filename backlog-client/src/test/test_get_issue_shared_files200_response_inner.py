...
class TestGetIssueSharedFiles200ResponseInner(unittest.TestCase):
    """GetIssueSharedFiles200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetIssueSharedFiles200ResponseInner:
        """Test GetIssueSharedFiles200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetIssueSharedFiles200ResponseInner`
        """
        model = GetIssueSharedFiles200ResponseInner()
        if include_optional:
            return GetIssueSharedFiles200ResponseInner(
                id = 56,
                project_id = 56,
                type = '',
                dir = '',
    ...
    def testGetIssueSharedFiles200ResponseInner(self):
        """Test GetIssueSharedFiles200ResponseInner"""
