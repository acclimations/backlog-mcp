...
class TestGetMyRecentlyViewedWikis200ResponsePage(unittest.TestCase):
    """GetMyRecentlyViewedWikis200ResponsePage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMyRecentlyViewedWikis200ResponsePage:
        """Test GetMyRecentlyViewedWikis200ResponsePage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMyRecentlyViewedWikis200ResponsePage`
        """
        model = GetMyRecentlyViewedWikis200ResponsePage()
        if include_optional:
            return GetMyRecentlyViewedWikis200ResponsePage(
                id = 56,
                project_id = 56,
                name = '',
                tags = [
    ...
    def testGetMyRecentlyViewedWikis200ResponsePage(self):
        """Test GetMyRecentlyViewedWikis200ResponsePage"""
