...
class TestGetProjectWebhooks200ResponseInner(unittest.TestCase):
    """GetProjectWebhooks200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectWebhooks200ResponseInner:
        """Test GetProjectWebhooks200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectWebhooks200ResponseInner`
        """
        model = GetProjectWebhooks200ResponseInner()
        if include_optional:
            return GetProjectWebhooks200ResponseInner(
                id = 56,
                name = '',
                description = '',
                hook_url = '',
    ...
    def testGetProjectWebhooks200ResponseInner(self):
        """Test GetProjectWebhooks200ResponseInner"""
