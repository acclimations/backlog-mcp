...
class TestGetPullRequests200ResponseInner(unittest.TestCase):
    """GetPullRequests200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPullRequests200ResponseInner:
        """Test GetPullRequests200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPullRequests200ResponseInner`
        """
        model = GetPullRequests200ResponseInner()
        if include_optional:
            return GetPullRequests200ResponseInner(
                id = 56,
                project_id = 56,
                repository_id = 56,
                number = 56,
                ...
                issue = backlog_client.models.get_pull_requests_200_response_inner_issue.getPullRequests_200_response_inner_issue(
                    id = 56, ),
                base_commit = '',
                branch_commit = '',
                merge_commit = '',
    ...
    def testGetPullRequests200ResponseInner(self):
        """Test GetPullRequests200ResponseInner"""
