...
class TestGetRecentlyViewedIssues200ResponseIssueSharedFilesInner(unittest.TestCase):
    """GetRecentlyViewedIssues200ResponseIssueSharedFilesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRecentlyViewedIssues200ResponseIssueSharedFilesInner:
        """Test GetRecentlyViewedIssues200ResponseIssueSharedFilesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRecentlyViewedIssues200ResponseIssueSharedFilesInner`
        """
        model = GetRecentlyViewedIssues200ResponseIssueSharedFilesInner()
        if include_optional:
            return GetRecentlyViewedIssues200ResponseIssueSharedFilesInner(
                id = 56,
                project_id = 56,
                type = '',
                dir = '',
    ...
    def testGetRecentlyViewedIssues200ResponseIssueSharedFilesInner(self):
        """Test GetRecentlyViewedIssues200ResponseIssueSharedFilesInner"""
