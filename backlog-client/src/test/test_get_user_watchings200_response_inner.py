...
class TestGetUserWatchings200ResponseInner(unittest.TestCase):
    """GetUserWatchings200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserWatchings200ResponseInner:
        """Test GetUserWatchings200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserWatchings200ResponseInner`
        """
        model = GetUserWatchings200ResponseInner()
        if include_optional:
            return GetUserWatchings200ResponseInner(
                id = 56,
                resource_already_read = True,
                note = '',
                type = '',
                issue = backlog_client.models.delete_watching_200_response_issue.deleteWatching_200_response_issue(
                    id = 56, 
                    project_id = 56, 
                    issue_key = '', 
                    key_id = 56, 
    ...
    def testGetUserWatchings200ResponseInner(self):
        """Test GetUserWatchings200ResponseInner"""
