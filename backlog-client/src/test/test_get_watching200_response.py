...
class TestGetWatching200Response(unittest.TestCase):
    """GetWatching200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWatching200Response:
        """Test GetWatching200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWatching200Response`
        """
        model = GetWatching200Response()
        if include_optional:
            return GetWatching200Response(
                id = 56,
                already_read = True,
                note = '',
                type = '',
                issue = backlog_client.models.get_watching_200_response_issue.getWatching_200_response_issue(
                    id = 56, 
                    project_id = 56, 
                    issue_key = '', 
                    key_id = 56, 
    ...
    def testGetWatching200Response(self):
        """Test GetWatching200Response"""
