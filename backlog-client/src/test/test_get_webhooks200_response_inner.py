...
class TestGetWebhooks200ResponseInner(unittest.TestCase):
    """GetWebhooks200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebhooks200ResponseInner:
        """Test GetWebhooks200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebhooks200ResponseInner`
        """
        model = GetWebhooks200ResponseInner()
        if include_optional:
            return GetWebhooks200ResponseInner(
                id = 56,
                name = '',
                description = '',
                hook_url = '',
    ...
    def testGetWebhooks200ResponseInner(self):
        """Test GetWebhooks200ResponseInner"""
