...
class TestGetWikiSharedFiles200ResponseInner(unittest.TestCase):
    """GetWikiSharedFiles200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWikiSharedFiles200ResponseInner:
        """Test GetWikiSharedFiles200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWikiSharedFiles200ResponseInner`
        """
        model = GetWikiSharedFiles200ResponseInner()
        if include_optional:
            return GetWikiSharedFiles200ResponseInner(
                id = 56,
                project_id = 56,
                type = '',
                dir = '',
    ...
    def testGetWikiSharedFiles200ResponseInner(self):
        """Test GetWikiSharedFiles200ResponseInner"""
